...
import { IBookingState } from "../Bookings/BookingsComponent";
            ...
            {data ?
                <>
                    <div>
                        ...
                        <p>Contact info: {data.number} {data.email}</p>
                        <p>Booking for: {data.date} {data.sitting}</p>
                        <p>{data.numberOfGuests} guests</p>
                    </div>
                    <button onClick={deleteBooking} type="button">Delete booking</button>
                </>
